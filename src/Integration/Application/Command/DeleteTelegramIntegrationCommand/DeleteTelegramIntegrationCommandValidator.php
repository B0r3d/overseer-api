...
class DeleteTelegramIntegrationCommandValidator implements CommandValidator
{
    ...
    {
        if (!$command instanceof DeleteTelegramIntegrationCommand) {
            throw new \InvalidArgumentException('Command must be an instance of ' . DeleteTelegramIntegrationCommand::class . ' got ' . get_class($command));
        }
