...
class DeleteWebhookIntegrationCommandValidator implements CommandValidator
{
    ...
    {
        if (!$command instanceof DeleteWebhookIntegrationCommand) {
            throw new \InvalidArgumentException('Command must be an instance of ' . DeleteWebhookIntegrationCommand::class . ' got ' . get_class($command));
        }
